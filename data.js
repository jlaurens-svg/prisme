...
fr: {
  ...
  ui: {
    ...
    schema:{
      eyebrow:"Le schéma", title:"Ce qui revient dans vos relations",
      lead:"Les personnes que vous gardez près de vous ne sont pas tirées au sort. Ce qui suit compte ce qui se répète parmi elles. Un schéma n’est pas un destin : c’est une habitude — et une habitude se voit avant de pouvoir changer.",
      thin:"Il faut au moins quatre personnes enregistrées pour qu’un schéma veuille dire quelque chose. Ajoutez vos proches dans votre compte, et revenez.",
      none:"Rien ne domine nettement : vos proches ne se ressemblent pas particulièrement. C’est une réponse en soi — vous ne recrutez pas dans une seule famille.",
      care:"Rien de tout cela ne dit que vous choisissez mal. Ça dit ce que vous cherchez, et parfois ce que vous rejouez. La question utile n’est pas « pourquoi eux ? » mais « qu’est-ce que ça me permet de ne pas faire ? ».",
      cptElement:(n,e,pc)=>`${n} de vos proches sur ${pc} partagent le même élément : ${e}.`,
      cptLettre:(n,tot,l)=>`${n} personnes sur ${tot} qui ont un type sont ${l}.`,
      cptVie:(n,ch)=>`${n} de vos proches ont le même chemin de vie : ${ch}.`,
      dom:{
        feu:"Du Feu, beaucoup. Vous allez vers des gens qui démarrent, qui tranchent, qui occupent l’espace — et qui vous mettent en mouvement. La contrepartie se paie en bruit, en départs brusques et en promesses tenues à moitié. Demandez-vous où est passé votre propre élan si ce sont toujours les autres qui l’apportent.",
        terre:"De la Terre, beaucoup. Vous vous entourez de gens fiables, tenus, qui font ce qu’ils disent. C’est reposant, et ça peut devenir étroit : personne autour de vous ne propose de tout renverser. Si vous rêvez de partir, remarquez que vous n’avez invité personne qui vous y pousserait.",
        air:"De l’Air, beaucoup. Vos proches parlent, analysent, mettent à distance — on discute bien, on rit beaucoup, et on esquive parfois. Regardez qui, dans cette liste, vous appellerait à trois heures du matin.",
        eau:"De l’Eau, beaucoup. Vous choisissez des gens qui sentent avant de comprendre, et avec qui l’intime va vite. C’est rare et précieux ; c’est aussi épuisant quand tout le monde a besoin d’être porté en même temps. Qui vous porte, vous ?",
      },
      absent:{
        feu:"Aucun signe de Feu autour de vous. Personne, dans votre entourage proche, n’est là pour vous bousculer ou vous faire commencer avant d’être prêt. Si vous attendez souvent un signal pour vous lancer, il ne viendra pas de cette liste.",
        terre:"Aucun signe de Terre autour de vous. Personne pour dire « et concrètement, on fait quoi lundi ? ». Ce que vous décidez ensemble a peu de chances d’atterrir tout seul.",
        air:"Aucun signe d’Air autour de vous. Personne pour prendre du recul, désamorcer par une phrase, ou remettre une dispute à sa taille. Tout se vit en intensité, faute d’un tiers qui relativise.",
        eau:"Aucun signe d’Eau autour de vous. On s’occupe bien de ce qui se fait, moins de ce qui se ressent. Si vous trouvez vos relations un peu sèches, ce n’est peut-être pas vous : c’est la composition.",
      },
      lettres:{
        E:"Vos proches sont surtout tournés vers l’extérieur : ça bouge, ça propose, ça remplit l’agenda. Le calme, vous allez devoir le prendre, personne ne vous le donnera.",
        I:"Vos proches sont surtout des intérieurs : peu de bruit, des liens profonds, peu d’initiatives sociales. Si vous trouvez que personne n’appelle jamais, c’est arithmétique.",
        S:"Vos proches ont les pieds sur terre : concrets, présents, attentifs au réel. Les grandes théories tombent souvent à plat, et c’est parfois exactement ce qu’il faut.",
        N:"Vos proches vivent dans les possibles : ça imagine, ça relie, ça projette. Le quotidien, lui, attend son tour — et attend souvent longtemps.",
        T:"Vos proches tranchent par la logique. On vous dira la vérité, pas ce que vous voulez entendre. Utile ; froid les jours où vous vouliez juste être plaint.",
        F:"Vos proches décident avec le cœur. On vous soutiendra même quand vous avez tort — confortable, et pas toujours ce qui vous fait avancer.",
        J:"Vos proches aiment que ce soit décidé : plans, dates, cadres. L’imprévu leur coûte, et vous finissez par annoncer vos changements en vous excusant.",
        P:"Vos proches gardent tout ouvert. Rien ne se fixe, on verra bien — reposant si vous menez, épuisant si vous attendez que quelqu’un décide.",
      },
      lienTitle:"Par type de lien",
      lienDom:(lien,el)=>`Du côté « ${lien} », c’est presque toujours le même élément : ${el}. Là où le reste de votre entourage varie, ce lien-là ne varie pas — c’est le plus intéressant de la page.`,
      lienThin:"Pas encore assez de monde par type de lien pour dire quoi que ce soit.",
      vieNote:"Un chemin de vie qui revient plusieurs fois autour de vous n’est pas une coïncidence utile à interpréter — c’est surtout un rappel que vous reconnaissez un certain fil, et que vous y retournez.",
    },
    lecture:{
      tag:"La lecture d’ensemble", title:"Ce que les prismes disent ensemble",
      text:"La synthèse au-dessus additionne les prismes ; elle ne peut pas voir là où ils se contredisent. Cette lecture-ci croise tout ce que vous avez renseigné — le thème, les nombres, le type, votre histoire, vos rêves, le ciel du jour — et cherche d’abord les désaccords : c’est là qu’il y a quelque chose à apprendre.",
      privacy:"Ce que vous cochez ci-dessous sortira de votre navigateur pour être analysé. Rien d’autre.",
      consent:"J’accepte que mon thème, mes nombres et mon type soient envoyés pour analyse.",
      consentHistoire:"Joindre mon histoire de vie (plus juste, et beaucoup plus intime).",
      consentReves:"Joindre mon journal de rêves.",
      button:"Demander la lecture", working:"Lecture en cours…", again:"Relire mon profil",
      setup:"Cette lecture demande une configuration.",
      setupKey:"En attendant, vous pouvez utiliser votre propre clé d’API Anthropic : elle reste sur cet appareil.",
      keyPh:"sk-ant-…", keySave:"Enregistrer la clé",
      lPortrait:"Le portrait", lFil:"Le fil", lAccords:"Là où les prismes s’accordent",
      lTensions:"Là où ils se contredisent", lAngle:"Ce que vous ne voyez probablement pas",
      lChantier:"Le chantier", lQuestion:"La question à garder", lGarde:"Ce qu’il ne faut pas en conclure",
      errCle:"La clé a été refusée. Vérifiez-la et recommencez.",
      errQuota:"La limite d’usage est atteinte. Réessayez plus tard.",
      errReseau:"La connexion a échoué. Réessayez.",
      errRefus:"Le modèle n’a pas donné suite à cette demande.",
...
en: {
  ...
  ui: {
    ...
    schema:{
      eyebrow:"The pattern", title:"What repeats in your relationships",
      lead:"The people you keep close were not drawn at random. What follows counts what repeats among them. A pattern is not a fate: it's a habit — and a habit has to be seen before it can change.",
      thin:"At least four people are needed for a pattern to mean anything. Add the people close to you in your account, and come back.",
      none:"Nothing clearly dominates: the people close to you don't particularly resemble each other. That's an answer in itself — you don't recruit from a single family.",
      care:"None of this says you choose badly. It says what you are looking for, and sometimes what you are replaying. The useful question isn't \"why them?\" but \"what does this let me avoid doing?\".",
      cptElement:(n,e,pc)=>`${n} of your ${pc} people share the same element: ${e}.`,
      cptLettre:(n,tot,l)=>`${n} out of ${tot} people with a type are ${l}.`,
      cptVie:(n,ch)=>`${n} of them share the same life path: ${ch}.`,
      dom:{
        feu:"A lot of Fire. You go toward people who start things, who cut through, who take up space — and who set you moving. The price is noise, sudden exits and half-kept promises. Ask where your own momentum went, if it's always others who bring it.",
        terre:"A lot of Earth. You surround yourself with reliable people who do what they say. That's restful, and it can become narrow: nobody around you proposes turning it all over. If you dream of leaving, notice you've invited nobody who would push you to.",
        air:"A lot of Air. Your people talk, analyse, keep their distance — the conversation is good, the laughs are many, and sometimes everyone dodges. Look at who, on this list, would take your call at three in the morning.",
        eau:"A lot of Water. You choose people who feel before they understand, and with whom intimacy comes fast. That's rare and precious; it's also exhausting when everyone needs carrying at once. Who carries you?",
      },
      absent:{
        feu:"No Fire signs around you. Nobody close is there to shake you up or make you start before you're ready. If you often wait for a signal to launch, it won't come from this list.",
        terre:"No Earth signs around you. Nobody to say \"and concretely, what do we do on Monday?\". What you decide together has little chance of landing on its own.",
        air:"No Air signs around you. Nobody to step back, defuse with a sentence, or cut an argument down to size. Everything is lived at full intensity, for want of a third party who relativises.",
        eau:"No Water signs around you. What gets done is well handled, what gets felt rather less. If you find your relationships a little dry, it may not be you: it's the composition.",
      },
      lettres:{
        E:"Your people are mostly turned outward: things move, plans get made, the calendar fills. Quiet is something you'll have to take; nobody will hand it to you.",
        I:"Your people are mostly inward: little noise, deep bonds, few social initiatives. If you feel nobody ever calls, it's arithmetic.",
        S:"Your people are grounded: concrete, present, attentive to the real. Grand theories often fall flat, and sometimes that's exactly what's needed.",
        N:"Your people live in the possible: imagining, connecting, projecting. The everyday waits its turn — often for a long time.",
        T:"Your people decide by logic. You'll be told the truth, not what you want to hear. Useful; cold on the days you just wanted sympathy.",
        F:"Your people decide with the heart. You'll be supported even when you're wrong — comfortable, and not always what moves you forward.",
        J:"Your people like things settled: plans, dates, frames. The unforeseen costs them, and you end up apologising for your own changes.",
        P:"Your people keep everything open. Nothing gets fixed, we'll see — restful if you lead, exhausting if you're waiting for someone to decide.",
      },
      lienTitle:"By kind of relationship",
      lienDom:(lien,el)=>`On the "${lien}" side, it's almost always the same element: ${el}. Where the rest of your circle varies, this bond doesn't — it's the most interesting thing on the page.`,
      lienThin:"Not enough people per kind of relationship yet to say anything.",
      vieNote:"A life path that recurs around you isn't a coincidence worth interpreting — it mostly means you recognise a certain thread, and you go back to it.",
    },
    lecture:{
      tag:"The whole reading", title:"What the lenses say together",
      text:"The synthesis above adds the lenses up; it can't see where they contradict each other. This reading crosses everything you've filled in — the chart, the numbers, the type, your history, your dreams, the sky of the day — and looks for the disagreements first: that's where there is something to learn.",
      privacy:"What you tick below will leave your browser to be analysed. Nothing else.",
      consent:"I agree that my chart, numbers and type be sent for analysis.",
      consentHistoire:"Include my life history (more accurate, and far more intimate).",
      consentReves:"Include my dream journal.",
      button:"Ask for the reading", working:"Reading…", again:"Read my profile again",
      setup:"This reading needs configuration.",
      setupKey:"In the meantime you can use your own Anthropic API key: it stays on this device.",
      keyPh:"sk-ant-…", keySave:"Save the key",
      lPortrait:"The portrait", lFil:"The thread", lAccords:"Where the lenses agree",
      lTensions:"Where they contradict each other", lAngle:"What you probably don't see",
      lChantier:"The growth edge", lQuestion:"The question to keep", lGarde:"What must not be concluded",
      errCle:"The key was refused. Check it and try again.",
      errQuota:"The usage limit has been reached. Try again later.",
      errReseau:"The connection failed. Try again.",
      errRefus:"The model did not act on this request.",
